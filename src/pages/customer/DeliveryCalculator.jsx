...
const DeliveryCalculator = ({ cartTotal, onDeliveryUpdate }) => {
  ...
  const districts = [
    ...
    },
    {
      name: "Kalutara",
      charge: 900,
      areas: ["kalutara", "panadura", "beruwala", "aluthgama"],
    },
    {
      name: "Kandy",
      charge: 800,
      areas: ["kandy", "peradeniya", "gampola", "katugastota"],
    },
    { name: "Matale", charge: 1000, areas: ["matale", "dambulla", "sigiriya"] },
    {
      name: "Nuwara Eliya",
      charge: 1200,
      areas: ["nuwara eliya", "hatton", "talawakelle", "nanu oya"],
    },
    {
      name: "Galle",
      charge: 1500,
      areas: ["galle", "hikkaduwa", "unawatuna", "bentota"],
    },
    {
      name: "Matara",
      charge: 1500,
      areas: ["matara", "mirissa", "weligama", "tangalle"],
    },
    {
      name: "Hambantota",
      charge: 1500,
      areas: ["hambantota", "tissamaharama", "kataragama"],
    },
    {
      name: "Kurunegala",
      charge: 1300,
      areas: ["kurunegala", "puttalam", "chilaw", "wariyapola"],
    },
    {
      name: "Anuradhapura",
      charge: 1700,
      areas: ["anuradhapura", "mihintale"],
    },
    ...
    { name: "Kegalle", charge: 1400, areas: ["kegalle", "mawanella"] },
    {
      name: "Badulla",
      charge: 1600,
      areas: ["badulla", "bandarawela", "ella"],
    },
  ...
  if (loading) {
    return (
      <div
        className="bg-white p-4 rounded-3 shadow border w-100"
        style={{ borderRadius: "15px", minWidth: "100%" }}
      >
    ...
    >
      ...
      {!userAddress && !showAddressForm ? (
        <div className="alert alert-info">
          ...
          <p className="mb-3">
            Please set the delivery address for this order to calculate delivery
            charges.
          </p>
          <button
            onClick={() => {
        ...
        <div
          className="border rounded-3 p-4 bg-light w-100"
          style={{ borderRadius: "12px" }}
        >
          <h5 className="mb-3 text-dark fw-medium">📍 Set Delivery Address</h5>
          <div className="alert alert-info mb-3 rounded-3">
            <small>
              <strong>Note:</strong> This delivery address will be used only for
              this order and won't update your profile address.
            </small>
          </div>
          <Form>
            ...
            <Form.Group className="mb-4">
              ...
              <small className="text-muted d-block mb-2">
                Please enter your complete street address and city (without
                district)
              </small>
              <Form.Control
                as="textarea"
        ...
        <div>
          {/* Address Display */}
          <div
            className="bg-light p-4 rounded-3 border w-100 mb-3"
            style={{ borderRadius: "12px" }}
          >
            <p className="small text-muted fw-medium mb-2">
              📍 Delivery Address:
            </p>
          ...
          <div
            className="bg-primary bg-opacity-10 p-4 rounded-3 border border-primary border-opacity-25 shadow-sm w-100"
            style={{ borderRadius: "12px" }}
          >
            ...
            <div className="border-top pt-2 mt-2">
              <div className="d-flex justify-content-between fw-bold">
                ...
                <span className="text-success">
                  {formatCurrency(
                    (Number(cartTotal) || 0) + (Number(deliveryCharge) || 0)
                  )}
                </span>
              </div>
            </div>
