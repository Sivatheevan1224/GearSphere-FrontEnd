...
const TechnicianRegistration = ({ technicianData, openFinalReg, onBack, onSuccess }) => {
  ...
  return (
    <div className={styles['tech-essential-registration']}>
      <div className={styles['tech-register-container']} style={{ position: 'relative' }}>
        {/* Close Button */}
        <button
          onClick={handleClose}
          style={{
          ...
          <form className={styles['tech-form']} onSubmit={handleSubmit}>
            ...
            <div className={styles['tech-input_box']}>
              ...
              <input
                ...
                required
              />
              <small className="text-muted">Upload your CV (PDF, DOC, DOCX)</small>
            </div>
